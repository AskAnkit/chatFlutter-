...
import 'package:huffduff/Models/chat_models.dart';
import 'package:huffduff/common_widgets/custom_app_bar.dart';
import 'package:huffduff/generated/assets.dart';
import 'package:huffduff/utils/app_colours.dart';
import 'package:huffduff/utils/dimensions.dart';
            ...
            builder: (context, snapShot) {
              return Column(
                ...
                children: [
                                                        ...
                                                        Align(
                                                          alignment: Alignment.centerRight,
                                                            child: Text(
                                                              ...
                                                              style: TextStyle(
                                                                color: AppColour.whiteColor.withOpacity(0.7),
                                              ...
                                              child: Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: Image.file(
                                                    ...
                                                    File(snapShot.data![index].message,),fit: BoxFit.cover,
                                                    ),
                                                ),
                                              ),
                                            ):Expanded(
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: AppColour.whiteColor.withOpacity(0.1),
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration:  InputDecoration(
                              ...
                              hintStyle: TextStyle(color: AppColour.whiteColor.withOpacity(0.7), fontSize: Dimensions.forteen)
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              if(_controller.profilepic.value.isNotEmpty)
                                ...
                                child: Image.asset(Assets.imagesOpenGalary,
                              ...
                              GestureDetector(
                                ...
                                child: SizedBox(
                                  height: 30,
                                  width: 30,
                                  child: Image.asset(Assets.imagesSenGreen),
                                ),
                              ),
                            ],
                          ),
